...
import { Antenna, Package, Tag, Zap, Radio } from 'lucide-react';
...
const products = [
  ...
  },
  {
    ...
    desc: 'Mission-critical grade IoT and enterprise network connectivity solutions from industry-leading partners like Teltonika and Celerway.',
...
export default function Products() {
  ...
  return (
    <section id="products" className="relative z-10 bg-[#f8fafc]">
